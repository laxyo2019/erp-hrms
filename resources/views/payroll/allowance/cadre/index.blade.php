      ...
      <div class="col-md-12 col-xl-12">
        <div class="card shadow-xs">
          <div class="col-md-12 col-xl-12" style="margin-top: 15px">
              <h1 style="font-size: 24px">Allowance By Cadre
                <a href="{{ route('allowance.index') }}" class="btn btn-sm btn-primary pull-right"  style="{background-color: #e7e7e7; color: black;}" >Back</a>
                <span class="ml-2">
                  <a href="{{route('by-cadre.create')}}" class="btn btn-sm btn-success" style="font-size: 13px">
               ...
               @php $count = 0; @endphp
                @foreach($allowances as $index)
                    <tr class="text-center" >
                      ...
                      <td>{{ucwords($index['cadre']->description)}}</td>
                      ...
                      <td>
                        <div class="row">
                          <div class="col" align="center">
                            <a href="{{route('by-cadre.edit', $index->id)}}" class="btn btn-sm btn-info">EDIT</a>
                          </div>
                          <div class="col" align="left">
                            <form  action=" {{route('by-cadre.destroy',$index->id)}} " method="POST" id="delform_{{ $index->id}}">
                              @csrf
                              @method('DELETE')

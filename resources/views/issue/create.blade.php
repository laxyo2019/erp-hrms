...
<main class="app-content">
	<div style=" padding: 1.5rem; border: 1px solid white;background: white">
		<h1 style="font-size: 24px">Generate Indent Here
		...
		<form action="{{route('issue-indent.store')}}" method="POST" id="loanRequest">
			@csrf
			<h5>Employee Detail</h5><hr>
			<div class="row">
				<div class="col-6 form-group">
					<label for="">Employee Name</label>
					{{-- <input type="text" class="form-control" name="emp_name" value="{{old('emp_name')}}" readonly=""> --}}
				...
				<div class="col-6 form-group">
					...
					<input type="text" class="form-control" name="emp_code" value="{{old('emp_code')}}" readonly="">
				</div>
			</div>

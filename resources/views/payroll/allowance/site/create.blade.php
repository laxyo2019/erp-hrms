	...
	<div style=" padding: 1.5rem; border: 1px solid white;background: white">
		{{-- <div class="col-md-12 col-xl-12"> --}}
			<h1 style="font-size: 24px">Add Allowance Here
				<a href="{{ route('by-site.index') }}" class="btn btn-sm btn-primary pull-right"  style="{background-color: #e7e7e7; color: black;}" >Go Back</a>
		</h1>
		{{-- </div> --}}
		...
		<form action="{{route('by-site.store')}}" method="POST" >
			@csrf
			<hr>
			<div class="row">

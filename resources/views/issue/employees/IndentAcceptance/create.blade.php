...
<main class="app-content">
	<div style=" padding: 1.5rem; border: 1px solid white;background: white">
			<h1 style="font-size: 24px">Indent Acknowledgement
				<a href="{{ route('my-indent.index') }}" class="btn btn-sm btn-primary pull-right"  style="{background-color: #e7e7e7; color: black;}" >Back</a>
		</h1><hr>
		<div>
		...
		<form action="{{route('no-dues-request.store')}}" method="POST" >
			...
			<div class="row">
				<div class="col-12 form-group">
					<label for="assets_description">Description (mention required articles/goods below.)

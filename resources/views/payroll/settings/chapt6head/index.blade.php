        ...
        <div class="card shadow-xs">
          <div class="col-md-12 col-xl-12" style="margin-top: 15px">
              <h1 style="font-size: 24px">Chapter 6 Section Heads
                ...
                <span class="ml-2">
                  <a href="{{route('chapt6-head.create')}}" class="btn btn-sm btn-success" style="font-size: 13px">
                      ...
                      <td>
                        <div class="row">
                          <div class="col" align="center">
                            <a href="{{route('chapt6-head.edit', $index->id)}}" class="btn btn-sm btn-info">EDIT</a>
                          </div>
                          <div class="col" align="left">
                            <form  action="{{route('chapt6-head.destroy',$index->id)}}" method="POST" id="delform_{{ $index->id}}">
                              @csrf
                              @method('DELETE')

        ...
        <div class="card shadow-xs">
          <div class="col-md-12 col-xl-12" style="margin-top: 15px">
              <h1 style="font-size: 24px">Allowance By Employee
                ...
                <span class="ml-2">
                  <a href="{{route('by-site.create')}}" class="btn btn-sm btn-success" style="font-size: 13px">
                      ...
                      <td>
                        <div class="row">
                          <div class="col" align="center">
                            <a href="{{route('by-site.edit', $index->id)}}" class="btn btn-sm btn-info">EDIT</a>
                          </div>
                          <div class="col" align="left">
                            <form  action=" {{route('by-site.destroy',$index->id)}} " method="POST" id="delform_{{ $index->id}}">
                              @csrf
                              @method('DELETE')

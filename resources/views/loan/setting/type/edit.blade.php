...
<main class="app-content">
	<div style=" padding: 1.5rem; border: 1px solid white;background: white">
		{{-- <div class="col-md-12 col-xl-12"> --}}
			<h1 style="font-size: 24px">Edit Loan Type Here
		...
		<form action="{{route('loan-types.update', $type->id)}}" method="POST" >
			@csrf
			@method('PATCH')
			<hr>
			<div class="row">
				<div class="col-6 form-group ">
					...
					<input type="text" class="form-control" name="name" value="{{old('value', $type->name)}}" id="name">
					@error('name')
				...
				<div class="col-6 form-group ">
					...
					<input type="text" class="form-control" name="interest_rate" value="{{old('interest_rate', $type->interest_rate)}}" id="interest_rate">
					@error('interest_rate')
						<span class="text-danger" role="alert">
							<strong>* {{ $message }}</strong>
						</span>

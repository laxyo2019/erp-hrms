...
class CreateLeavesTable extends Migration
{
    ...
    public function up()
    {
      Schema::create('hrms_leave_mast', function (Blueprint $table) {
        ...
        $table->integer('docs_required')->default(0);
        $table->integer('without_pay')->default(0);
        $table->integer('dont_show')->nullable();
        $table->timestamps();
        $table->softDeletes();
      });

      Schema::create('hrms_emp_leave_allotment', function (Blueprint $table) {
        $table->bigIncrements('id');
      ...
      Schema::create('hrms_leave_allotment_detail', function (Blueprint $table) {
        $table->bigIncrements('id');
        $table->integer('leave_mast_id');
        $table->integer('user_id');
      ...
      Schema::create('hrms_emp_leave_applies', function (Blueprint $table) {
        $table->bigIncrements('id');
        $table->integer('user_id');
      ...
      Schema::create('hrms_leave_approval_detail', function (Blueprint $table){
        $table->bigIncrements('id');
...
******/
    ...
    {
      Schema::dropIfExists('hrms_leave_allotment_detail');
      Schema::dropIfExists('hrms_leave_mast');
      Schema::dropIfExists('hrms_emp_leave_applies');
      Schema::dropIfExists('hrms_emp_leave_allotment');
      Schema::dropIfExists('hrms_holidays');
      Schema::dropIfExists('hrms_leave_approval_detail');
